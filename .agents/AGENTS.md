# ADESSA Project Rules & Guidelines

## Core Behavioral Constraints (Strictly Mandated by User)
1. **Never Delete Code or Files Without Explicit Permission**: Do NOT remove existing components, sections, features, or code logic unless the user explicitly commands it.
