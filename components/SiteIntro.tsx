 ...
 * Pure black stage from the very first paint — no framed image, no flash.
 * The white LIMIXI mark grows from a point at the center via a smooth
 * circular clip-reveal, holds, shows "Loading…" with a gentle dot sequence,
 * then scales up 2% and fades into the app. ~3s total.
 *
...
export function SiteIntro() {
  ...
  // Only paint the mark after mount so the first frame is pure black with no
  // flash of the full static image before the reveal is ready.
        ...
        >
          {mounted && (
            <>
              ...
              {!reduceMotion && (
                <motion.div
                  className="mt-9 flex items-center text-white/50 text-xs font-light"
