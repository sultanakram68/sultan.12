          ...
          {item.imageUrl ? (
            <>
              <Image
                ...
                className={`relative z-10 object-contain object-bottom translate-y-[5%] scale-[0.93] drop-shadow-xl transition-transform duration-500 ease-out group-hover:scale-[0.98] motion-reduce:transition-none motion-reduce:transform-none ${
