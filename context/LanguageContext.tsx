...
export const translations: Translations = {
  ...
  "faq.warranty.q": {
    en: "Do devices come with a warranty?",
    ar: "هل الأجهزة فيها ضمان؟",
    tr: "Cihazların garantisi var mı?",
    de: "Haben die Geräte eine Garantie?",
  },
  "faq.warranty.a": {
    en: "Yes, all devices come with a genuine warranty covering manufacturing defects.",
    ar: "أكيد، كل الأجهزة عنا فيها كفالة وضمان حقيقي يغطي أي عيب مصنعي.",
    tr: "Evet, tüm cihazlarımız üretim hatalarına karşı gerçek garantiyle gelir.",
    de: "Ja, alle Geräte haben eine echte Garantie gegen Herstellungsfehler.",
  },
  "faq.delivery.q": {
    en: "Do you deliver, or is pickup only from the shop?",
    ar: "في عندكم توصيل ولا بس استلام من المحل؟",
    tr: "Teslimat yapıyor musunuz, yoksa sadece mağazadan mı teslim alınıyor?",
    de: "Liefern Sie, oder nur Abholung im Laden?",
  },
  "faq.delivery.a": {
    en: "You can visit the shop directly, or contact us on WhatsApp to arrange delivery.",
    ar: "فيك تجي عالمحل مباشرة، أو تواصل معنا عالواتساب ونرتبلك توصيل.",
    tr: "Doğrudan mağazayı ziyaret edebilir veya WhatsApp üzerinden teslimat için bize ulaşabilirsiniz.",
    de: "Sie können den Laden direkt besuchen oder uns auf WhatsApp für eine Lieferung kontaktieren.",
  },
  "faq.return.q": {
    en: "What is your return / exchange policy?",
    ar: "شو سياسة الاستبدال والإرجاع؟",
    tr: "İade / değişim politikanız nedir?",
    de: "Wie ist Ihre Rückgabe-/Umtauschrichtlinie?",
  },
  "faq.return.a": {
    en: "Contact us on WhatsApp within the warranty period and we'll help you with an exchange or repair.",
    ar: "تواصل معنا عالواتساب خلال فترة الضمان ومنساعدك بالاستبدال أو الصيانة.",
    tr: "Garanti süresi içinde WhatsApp üzerinden bize ulaşın, değişim veya onarımda size yardımcı olalım.",
    de: "Kontaktieren Sie uns innerhalb der Garantiezeit auf WhatsApp, wir helfen Ihnen beim Umtausch oder der Reparatur.",
  },
  "faq.payment.q": {
    en: "What payment methods do you accept?",
    ar: "شو طرق الدفع المتوفرة؟",
    tr: "Hangi ödeme yöntemlerini kabul ediyorsunuz?",
    de: "Welche Zahlungsmethoden akzeptieren Sie?",
  },
  "faq.payment.a": {
    en: "Cash payment in the shop, plus instant credit top-up and bill payment for all networks.",
    ar: "الدفع كاش بالمحل، وكمان في عنا شحن رصيد ودفع فواتير فوري لكافة الشبكات.",
    tr: "Mağazada nakit ödeme, ayrıca tüm operatörler için anında bakiye yükleme ve fatura ödeme.",
    de: "Barzahlung im Laden, sowie sofortiges Guthaben-Aufladen und Rechnungszahlung für alle Netze.",
  },
  "nav.favorites": {
    en: "Featured Devices",
    ar: "الأجهزة المميزة",
